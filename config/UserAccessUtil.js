...
class Roles{
 ...
 var AEE = {};
		...
		AEE.SURYADEEP   = {userId:5707794741198848, roles:[Role.MEMBER, Role.ADMIN, Role.ADMIN_BENGALI, Role.ADMIN_GUJARATI, Role.ADMIN_HINDI, Role.ADMIN_KANNADA, Role.ADMIN_MALAYALAM, Role.ADMIN_MARATHI, Role.ADMIN_TAMIL, Role.ADMIN_TELUGU]};
		AEE.RAJAT   	= {userId:5116047233384448, roles:[Role.MEMBER, Role.ADMIN, Role.ADMIN_HINDI ]};
