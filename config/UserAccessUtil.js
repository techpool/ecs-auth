...
const MEMBER_ACCESS =[
			...
			AccessType.VOTE,AccessType.PRATILIPI_READ_CONTENT,AccessType.PRATILIPI_READ_DRAFT_CONTENT];
...
const ADMIN_ACCESS = [
  AccessType.INIT_UPDATE,
			...
			AccessType.AUTHOR_LIST, AccessType.AUTHOR_ADD, AccessType.AUTHOR_UPDATE, AccessType.AUTHOR_READ, AccessType.AUTHOR_PRATILIPIS_READ, AccessType.AUTHOR_PRATILIPIS_ADD,
			AccessType.EVENT_ADD, AccessType.EVENT_UPDATE,
			AccessType.BLOG_POST_LIST, AccessType.BLOG_POST_ADD, AccessType.BLOG_POST_UPDATE, AccessType.I18N_UPDATE,AccessType.PRATILIPI_READ_DRAFT_CONTENT
];
...
class Roles{
 ...
 var AEE = {};
		...
		AEE.AKSHAY      = {userId:6755388383982685, roles:[Role.MEMBER, Role.ADMIN, Role.ADMIN_KANNADA ]};
		...
		AEE.SURYADEEP   = {userId:5853379468197888, roles:[Role.MEMBER, Role.ADMIN, Role.ADMIN_BENGALI, Role.ADMIN_GUJARATI, Role.ADMIN_HINDI, Role.ADMIN_KANNADA, Role.ADMIN_MALAYALAM, Role.ADMIN_MARATHI, Role.ADMIN_TAMIL, Role.ADMIN_TELUGU]};
		AEE.GAURIDEVO 	= {userId:9, roles:[Role.MEMBER, Role.ADMIN, Role.ADMIN_BENGALI, Role.ADMIN_GUJARATI, Role.ADMIN_HINDI, Role.ADMIN_KANNADA, Role.ADMIN_MALAYALAM, Role.ADMIN_MARATHI, Role.ADMIN_TAMIL, Role.ADMIN_TELUGU ]};
		AEE.GABBARDEVO 	= {userId:6, roles:[Role.MEMBER, Role.ADMIN, Role.ADMIN_BENGALI, Role.ADMIN_GUJARATI, Role.ADMIN_HINDI, Role.ADMIN_KANNADA, Role.ADMIN_MALAYALAM, Role.ADMIN_MARATHI, Role.ADMIN_TAMIL, Role.ADMIN_TELUGU ]};
